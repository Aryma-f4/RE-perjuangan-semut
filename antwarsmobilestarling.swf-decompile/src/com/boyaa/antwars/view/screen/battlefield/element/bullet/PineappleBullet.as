package com.boyaa.antwars.view.screen.battlefield.element.bullet
{
   ...
   public class PineappleBullet extends Bullet
   {
      
      public function PineappleBullet(param1:ICharacterCtrl, param2:int = 0)
      {
         super(param1);
         this.bulletDisplay = new Image(Assets.sAsset.getTextureAtlas("wqSpritesheet").getTexture("bl" + param2));
         this.size = 50;
         this.bombRange = 140;
         this.setParticle();
         this.setHitModel();
      ...
      {
         blowoutAnimation = new MovieClip(Assets.sAsset.getTextureAtlas("wqSpritesheet").getTextures("blbz00"),13);
