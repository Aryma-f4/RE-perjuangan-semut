package com.boyaa.antwars.view.screen.battlefield.element.bullet
{
   ...
   public class SnowballBullet extends Bullet
   {
      ...
      public function SnowballBullet(param1:ICharacterCtrl, param2:int = 0)
      {
         super(param1);
         this.bulletDisplay = new Image(Assets.sAsset.getTextureAtlas("wqSpritesheet").getTexture("xq"));
         this.size = 50;
         this.bombRange = 170;
         this.setParticle();
         this.setHitModel();
      ...
      {
         blowoutAnimation = new MovieClip(Assets.sAsset.getTextureAtlas("wqSpritesheet").getTextures("xq00"),13);
      ...
      override protected function initCrater() : void
      {
         ...
         brink = new Image(Assets.sAsset.getTextureAtlas("wqSpritesheet").getTexture("xqk0"));
