package com.boyaa.antwars.view.screen.battlefield.element.bullet
{
   ...
   public class WatermelonBullet extends Bullet
   {
      
      public function WatermelonBullet(param1:ICharacterCtrl, param2:int = 0)
      {
         super(param1);
         this.bulletDisplay = new Image(Assets.sAsset.getTextureAtlas("wqSpritesheet").getTexture("xg" + param2));
         this.size = 50;
         this.bombRange = 160;
         this.setParticle();
         this.setHitModel();
      ...
      {
         blowoutAnimation = new MovieClip(Assets.sAsset.getTextureAtlas("wqSpritesheet").getTextures("xgbz00"),13);
      ...
      override protected function initCrater() : void
      {
         ...
         brink = new Image(Assets.sAsset.getTextureAtlas("wqSpritesheet").getTexture("xgk0"));
