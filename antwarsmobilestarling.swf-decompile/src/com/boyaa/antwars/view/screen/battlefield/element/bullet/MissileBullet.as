package com.boyaa.antwars.view.screen.battlefield.element.bullet
{
   ...
   public class MissileBullet extends Bullet
   {
      ...
      public function MissileBullet(param1:ICharacterCtrl, param2:int = 0)
      {
         super(param1);
         this.bulletDisplay = new Image(Assets.sAsset.getTextureAtlas("wqSpritesheet").getTexture("daodan01"));
         this.bulletDisplay.pivotX = this.bulletDisplay.width / 2 - 30;
         this.size = 50;
         this.bombRange = 160;
         this.setParticle();
         this.setHitModel();
