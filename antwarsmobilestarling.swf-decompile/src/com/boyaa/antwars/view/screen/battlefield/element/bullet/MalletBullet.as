package com.boyaa.antwars.view.screen.battlefield.element.bullet
{
   ...
   public class MalletBullet extends Bullet
   {
      
      public function MalletBullet(param1:ICharacterCtrl, param2:int = 0)
      {
         super(param1);
         this.bulletDisplay = new Image(Assets.sAsset.getTextureAtlas("wqSpritesheet").getTexture("mallet"));
         this.size = 50;
         this.bombRange = 140;
         this.setParticle();
         this.setHitModel();
      ...
      {
         blowoutAnimation = new MovieClip(Assets.sAsset.getTextureAtlas("wqSpritesheet").getTextures("mc00"),13);
