package com.boyaa.antwars.view.monster.Animation
{
   ...
   public class SpittleBullet extends Bullet
   {
      
      public function SpittleBullet(param1:ICharacterCtrl, param2:int = 0)
      {
         super(param1);
         this.bulletDisplay = new MovieClip(Assets.sAsset.getTextures("tx700"),15);
      ...
      {
         blowoutAnimation = new MovieClip(Assets.sAsset.getTextures("yt00"),10);
