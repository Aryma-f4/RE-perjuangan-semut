package com.adobe.utils
{
   ...
   public class AGALMiniAssembler
   {
      ...
      public function assemble(param1:String, param2:String, param3:uint = 1, param4:Boolean = false) : ByteArray
      {
         ...
         var _loc47_:Register = null;
         var _loc8_:Array = null;
         var _loc24_:Array = null;
         var _loc42_:* = 0;
         var _loc25_:* = 0;
         var _loc22_:Number = NaN;
         var _loc41_:Sampler = null;
         var _loc18_:String = null;
         var _loc20_:* = 0;
         var _loc27_:* = 0;
         var _loc46_:String = null;
         var _loc44_:uint = uint(getTimer());
         ...
         agalcode.writeByte(_loc45_ ? 1 : 0);
         initregmap(param3,param4);
         var _loc48_:Array = param2.replace(/[\f\n\r\v]+/g,"\n").split("\n");
         var _loc29_:int = 0;
         var _loc38_:int = 0;
         var _loc13_:int = int(_loc48_.length);
         _loc37_ = 0;
         while(_loc37_ < _loc13_ && _error == "")
         {
            _loc12_ = new String(_loc48_[_loc37_]);
            _loc12_ = _loc12_.replace(REGEXP_OUTER_SPACES,"");
            _loc40_ = int(_loc12_.search("//"));
            if(_loc40_ != -1)
            {
               _loc12_ = _loc12_.slice(0,_loc40_);
            }
            _loc6_ = int(_loc12_.search(/<.*>/g));
            if(_loc6_ != -1)
            {
               _loc7_ = _loc12_.slice(_loc6_).match(/([\w\.\-\+]+)/gi);
               _loc12_ = _loc12_.slice(0,_loc6_);
            }
            ...
            if(!_loc17_)
            {
               if(_loc12_.length >= 3)
               {
                  trace("warning: bad line " + _loc37_ + ": " + _loc48_[_loc37_]);
               }
            }
            else
            {
               ...
               else
               {
                  ...
                  if(_loc21_.flags & 0x40 && _loc45_)
                  {
                     _error = "error: opcode is only allowed in vertex programs.";
                     break;
                  }
                  if(_loc21_.flags & 0x20 && !_loc45_)
                  {
                  ...
                  _loc31_ = _loc12_.match(/vc\[([vof][acostdip]?)(\d*)?(\.[xyzw](\+\d{1,3})?)?\](\.[xyzw]{1,4})?|([vof][acostdip]?)(\d*)?(\.[xyzw]{1,4})?/gi);
                  if(!_loc31_ || _loc31_.length != _loc21_.numRegister)
                  {
                     _error = "error: wrong number of operands. found " + _loc31_.length + " but expected " + _loc21_.numRegister + ".";
                     break;
                  }
                  _loc39_ = false;
                  _loc26_ = 160;
                  _loc9_ = _loc31_.length;
                  _loc33_ = 0;
                  while(_loc33_ < _loc9_)
                  {
                     _loc19_ = false;
                     _loc30_ = _loc31_[_loc33_].match(/\[.*\]/gi);
                     if(_loc30_ && _loc30_.length > 0)
                     {
                        _loc31_[_loc33_] = _loc31_[_loc33_].replace(_loc30_[0],"0");
                        if(verbose)
                        {
                           trace("IS REL");
                        }
                     ...
                     _loc5_ = _loc31_[_loc33_].match(/^\b[A-Za-z]{1,2}/gi);
                     if(!_loc5_)
                     {
                        _error = "error: could not parse operand " + _loc33_ + " (" + _loc31_[_loc33_] + ").";
                        _loc39_ = true;
                        break;
                     }
                     _loc16_ = REGMAP[_loc5_[0]];
                     if(debugEnabled)
                     {
                        trace(_loc16_);
                     }
                     if(_loc16_ == null)
                     {
                        _error = "error: could not find register name for operand " + _loc33_ + " (" + _loc31_[_loc33_] + ").";
                        _loc39_ = true;
                        break;
                     }
                     if(_loc45_)
                     {
                        ...
                        {
                           _error = "error: register operand " + _loc33_ + " (" + _loc31_[_loc33_] + ") only allowed in vertex programs.";
                           _loc39_ = true;
                           break;
                        }
                        if(_loc19_)
                        {
                           _error = "error: register operand " + _loc33_ + " (" + _loc31_[_loc33_] + ") relative adressing not allowed in fragment programs.";
                           _loc39_ = true;
                           break;
                        }
                     }
                     ...
                     {
                        _error = "error: register operand " + _loc33_ + " (" + _loc31_[_loc33_] + ") only allowed in fragment programs.";
                        _loc39_ = true;
                        break;
                     }
                     _loc31_[_loc33_] = _loc31_[_loc33_].slice(_loc31_[_loc33_].search(_loc16_.name) + _loc16_.name.length);
                     _loc28_ = _loc19_ ? _loc30_[0].match(/\d+/) : _loc31_[_loc33_].match(/\d+/);
                     _loc36_ = 0;
                     if(_loc28_)
                     {
                        _loc36_ = uint(_loc28_[0]);
                     }
                     if(_loc16_.range < _loc36_)
                     {
                        _error = "error: register operand " + _loc33_ + " (" + _loc31_[_loc33_] + ") index exceeds limit of " + (_loc16_.range + 1) + ".";
                        _loc39_ = true;
                        break;
                     }
                     _loc49_ = 0;
                     _loc50_ = _loc31_[_loc33_].match(/(\.[xyzw]{1,4})/);
                     _loc14_ = _loc33_ == 0 && !(_loc21_.flags & 0x80);
                     _loc10_ = _loc33_ == 2 && _loc21_.flags & 8;
                     _loc43_ = 0;
                     _loc35_ = 0;
                     _loc15_ = 0;
                     if(_loc14_ && _loc19_)
                     ...
                     {
                        _loc49_ = 0;
                        _loc11_ = uint(_loc50_[0].length);
                        _loc34_ = 1;
                        while(_loc34_ < _loc11_)
                        {
                           _loc32_ = _loc50_[0].charCodeAt(_loc34_) - "x".charCodeAt(0);
                           if(_loc32_ > 2)
                           {
                              _loc32_ = 3;
                           }
                     ...
                     {
                        _loc49_ = _loc14_ ? 15 : 228;
                     }
                     if(_loc19_)
                     {
                        _loc23_ = _loc30_[0].match(/[A-Za-z]{1,2}/gi);
                        _loc47_ = REGMAP[_loc23_[0]];
                        if(_loc47_ == null)
                        {
                        ...
                        _loc43_ = _loc47_.emitCode;
                        _loc8_ = _loc30_[0].match(/(\.[xyzw]{1,1})/);
                        if(_loc8_.length == 0)
                        {
                        ...
                        _loc35_ = _loc8_[0].charCodeAt(1) - "x".charCodeAt(0);
                        if(_loc35_ > 2)
                        {
                           _loc35_ = 3;
                        }
                        _loc24_ = _loc30_[0].match(/\+\d{1,3}/gi);
                        if(_loc24_.length > 0)
                        {
                        ...
                        if(verbose)
                        {
                           trace("RELATIVE: type=" + _loc43_ + "==" + _loc23_[0] + " sel=" + _loc35_ + "==" + _loc8_[0] + " idx=" + _loc36_ + " offset=" + _loc15_);
                        }
                     }
                     if(verbose)
                     {
                        trace("  emit argcode=" + _loc16_ + "[" + _loc36_ + "][" + _loc49_ + "]");
                     }
                     if(_loc14_)
                     {
                        agalcode.writeShort(_loc36_);
                     ...
                     else if(_loc10_)
                     {
                        ...
                        _loc42_ = 5;
                        _loc25_ = uint(_loc7_ == null ? 0 : _loc7_.length);
                        _loc22_ = 0;
                        _loc34_ = 0;
                        while(_loc34_ < _loc25_)
                        {
                           if(verbose)
                           {
                              trace("    opt: " + _loc7_[_loc34_]);
                           }
                           _loc41_ = SAMPLEMAP[_loc7_[_loc34_]];
                           if(_loc41_ == null)
                           {
                              _loc22_ = Number(_loc7_[_loc34_]);
                              if(verbose)
                              {
                                 trace("    bias: " + _loc22_);
                              }
                           ...
                           else
                           {
                              if(_loc41_.flag != 16)
                              {
                                 _loc42_ &= ~(15 << _loc41_.flag);
                              }
                              _loc42_ |= _loc41_.mask << _loc41_.flag;
                           }
                           _loc34_++;
                        }
                        agalcode.writeShort(_loc36_);
                        ...
                        agalcode.writeUnsignedInt(_loc42_);
                        if(verbose)
                        {
                     ...
                     else
                     {
                        ...
                        agalcode.writeByte(_loc49_);
                        agalcode.writeByte(_loc16_.emitCode);
                        agalcode.writeByte(_loc43_);
                        agalcode.writeShort(_loc19_ ? _loc35_ | 0x8000 : 0);
                        _loc26_ -= 64;
                     }
                     _loc33_++;
                  }
         ...
         if(_error != "")
         {
            _error += "\n  at line " + _loc37_ + " " + _loc48_[_loc37_];
            agalcode.length = 0;
            trace(_error);
         }
         if(debugEnabled)
         {
            ...
            while(_loc27_ < _loc20_)
            {
               ...
               _loc46_ = agalcode[_loc27_].toString(16);
               if(_loc46_.length < 2)
               {
                  _loc46_ = "0" + _loc46_;
               }
         ...
         if(verbose)
         {
            trace("AGALMiniAssembler.assemble time: " + (getTimer() - _loc44_) / 1000 + "s");
         }
         return agalcode;
      }
