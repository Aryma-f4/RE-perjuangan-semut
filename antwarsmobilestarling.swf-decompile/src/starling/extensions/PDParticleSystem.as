package starling.extensions
{
   ...
   public class PDParticleSystem extends ParticleSystem
   {
      ...
      override protected function initParticle(param1:Particle) : void
      {
         ...
         {
            _loc12_.red += mStartColorVariance.red * (Math.random() * 2 - 1);
         }
         if(mStartColorVariance.green != 0)
         {
            _loc12_.green += mStartColorVariance.green * (Math.random() * 2 - 1);
         }
         if(mStartColorVariance.blue != 0)
         {
            _loc12_.blue += mStartColorVariance.blue * (Math.random() * 2 - 1);
         }
         if(mStartColorVariance.alpha != 0)
         {
            _loc12_.alpha += mStartColorVariance.alpha * (Math.random() * 2 - 1);
         }
         ...
         {
            _loc14_ += mEndColorVariance.red * (Math.random() * 2 - 1);
         }
         if(mEndColorVariance.green != 0)
         {
            _loc11_ += mEndColorVariance.green * (Math.random() * 2 - 1);
         }
         if(mEndColorVariance.blue != 0)
         {
            _loc10_ += mEndColorVariance.blue * (Math.random() * 2 - 1);
         }
         if(mEndColorVariance.alpha != 0)
         {
            _loc2_ += mEndColorVariance.alpha * (Math.random() * 2 - 1);
         }
      ...
      override protected function advanceParticle(param1:Particle, param2:Number) : void
      {
         ...
         param2 = _loc8_ > param2 ? param2 : _loc8_;
         ...
         else
         {
            ...
            _loc11_ *= _loc3_.radialAcceleration;
            _loc6_ = _loc12_;
            _loc12_ = -_loc9_ * _loc3_.tangentialAcceleration;
            _loc9_ = _loc6_ * _loc3_.tangentialAcceleration;
            _loc3_.velocityX += param2 * (mGravityX + _loc10_ + _loc12_);
            _loc3_.velocityY += param2 * (mGravityY + _loc11_ + _loc9_);
      ...
      private function parseConfig(param1:XML) : void
      {
         ...
         var getIntValue:* = function(param1:XMLList):int
         {
            return parseInt(param1.attribute("value"));
         };
         var getFloatValue:* = function(param1:XMLList):Number
         {
            return parseFloat(param1.attribute("value"));
         };
         var getColor:* = function(param1:XMLList):ColorArgb
         {
         ...
         var getBlendFunc:* = function(param1:XMLList):String
         {
