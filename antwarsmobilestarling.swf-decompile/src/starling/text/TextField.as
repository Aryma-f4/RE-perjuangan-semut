package starling.text
{
   ...
   public class TextField extends DisplayObjectContainer
   {
      ...
      private function renderText(param1:Number, param2:Rectangle) : BitmapData
      {
         ...
         var _loc12_:Number = mHitArea.height * param1;
         ...
         var _loc13_:TextFormat = new TextFormat(mFontName,mFontSize * param1,mColor,mBold,mItalic,mUnderline,null,null,_loc6_);
         _loc13_.kerning = mKerning;
         sNativeTextField.defaultTextFormat = _loc13_;
         sNativeTextField.width = _loc5_;
         sNativeTextField.height = _loc12_;
         ...
         formatText(sNativeTextField,_loc13_);
         if(mAutoScale)
         {
         ...
         if(isHorizontalAutoSize)
         {
            sNativeTextField.width = _loc5_ = Math.ceil(_loc10_ + 5);
         }
         if(isVerticalAutoSize)
         {
            sNativeTextField.height = _loc12_ = Math.ceil(_loc3_ + 4);
         }
         if(_loc5_ < 1)
         {
            _loc5_ = 1;
         ...
         var _loc11_:BitmapData = new BitmapData(_loc5_,_loc12_,true,0);
         var _loc14_:Matrix = new Matrix(1,0,0,1,_loc15_.x,_loc15_.y + int(_loc8_) - 2);
         var _loc9_:Function = "drawWithQuality" in _loc11_ ? _loc11_["drawWithQuality"] : null;
         if(_loc9_ is Function)
         {
            _loc9_.call(_loc11_,sNativeTextField,_loc14_,null,null,null,false,"medium");
         }
         else
         {
            _loc11_.draw(sNativeTextField,_loc14_);
         }
