package starling.text
{
   ...
   public class BitmapFont
   {
      ...
      private function parseFontXml(param1:XML) : void
      {
         ...
         for each(var _loc10_ in param1.chars.char)
         {
            _loc12_ = parseInt(_loc10_.@id);
            _loc14_ = parseFloat(_loc10_.@xoffset) / _loc3_;
            _loc4_ = parseFloat(_loc10_.@yoffset) / _loc3_;
            _loc7_ = parseFloat(_loc10_.@xadvance) / _loc3_;
            _loc2_ = new Rectangle();
            _loc2_.x = parseFloat(_loc10_.@x) / _loc3_ + _loc15_;
            _loc2_.y = parseFloat(_loc10_.@y) / _loc3_ + _loc17_;
            _loc2_.width = parseFloat(_loc10_.@width) / _loc3_;
            _loc2_.height = parseFloat(_loc10_.@height) / _loc3_;
            _loc8_ = Texture.fromTexture(mTexture,_loc2_);
            _loc9_ = new BitmapChar(_loc12_,_loc8_,_loc14_,_loc4_,_loc7_);
            addChar(_loc12_,_loc9_);
         }
      ...
      public function fillQuadBatch(param1:QuadBatch, param2:Number, param3:Number, param4:String, param5:Number = -1, param6:uint = 16777215, param7:String = "center", param8:String = "center", param9:Boolean = true, param10:Boolean = true) : void
      {
         ...
         while(_loc14_ < _loc11_)
         {
            ...
            mHelperImage.texture = _loc13_.char.texture;
            mHelperImage.readjustSize();
            mHelperImage.x = _loc13_.x;
            mHelperImage.y = _loc13_.y;
            mHelperImage.scaleX = mHelperImage.scaleY = _loc13_.scale;
