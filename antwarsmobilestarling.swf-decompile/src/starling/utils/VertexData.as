package starling.utils
{
   ...
   public class VertexData
   {
      ...
      public function setColorAndAlpha(param1:int, param2:uint, param3:Number) : void
      {
         ...
         mRawData[_loc4_ + 1] = (param2 >> 8 & 0xFF) / 255 * _loc5_;
         mRawData[_loc4_ + 2] = (param2 & 0xFF) / 255 * _loc5_;
      ...
      public function setColor(param1:int, param2:uint) : void
      {
         ...
         mRawData[_loc3_ + 1] = (param2 >> 8 & 0xFF) / 255 * _loc4_;
         mRawData[_loc3_ + 2] = (param2 & 0xFF) / 255 * _loc4_;
      }
      ...
      public function getColor(param1:int) : uint
      {
         ...
         var _loc5_:Number = mPremultipliedAlpha ? mRawData[_loc6_ + 3] : 1;
         if(_loc5_ == 0)
         {
            return 0;
         }
