package feathers.core
{
   ...
   public class DefaultPopUpManager implements IPopUpManager
   {
      ...
      public function set root(param1:DisplayObjectContainer) : void
      {
         ...
         var _loc6_:int = int(this._popUps.length);
      ...
      {
         var _loc3_:int = int(this._popUps.indexOf(param1));
         if(_loc3_ < 0)
         {
      ...
      public function isTopLevelPopUp(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc5_ >= 0)
         {
            ...
            _loc3_ = this._popUpToOverlay[_loc4_] as DisplayObject;
            if(_loc3_)
            {
               return false;
            }
      ...
      protected function popUp_resizeHandler(param1:Event) : void
      {
         ...
         var _loc2_:int = int(this._centeredPopUps.indexOf(_loc3_));
         if(_loc2_ < 0)
         {
            return;
         }
      ...
      protected function popUp_removedFromStageHandler(param1:Event) : void
      {
         ...
         var _loc3_:int = int(this._popUps.indexOf(_loc5_));
         ...
         var _loc2_:IFocusManager = this._popUpToFocusManager[_loc5_] as IFocusManager;
         if(_loc2_)
         {
            delete this._popUpToFocusManager[_loc5_];
            FocusManager.removeFocusManager(_loc2_);
         }
         _loc3_ = int(this._centeredPopUps.indexOf(_loc5_));
         if(_loc3_ >= 0)
         {
      ...
      protected function stage_resizeHandler(param1:ResizeEvent) : void
      {
         ...
         _loc6_ = int(this._centeredPopUps.length);
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
