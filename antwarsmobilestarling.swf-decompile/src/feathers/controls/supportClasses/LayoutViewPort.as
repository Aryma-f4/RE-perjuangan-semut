package feathers.controls.supportClasses
{
   ...
   public class LayoutViewPort extends LayoutGroup implements IViewPort
   {
      ...
      override protected function handleManualLayout() : void
      {
         ...
         var _loc6_:* = 0;
         var _loc9_:Number;
         var _loc4_:* = _loc9_ = this.viewPortBounds.explicitWidth;
         if(_loc4_ !== _loc4_)
         {
            _loc4_ = 0;
         }
         var _loc13_:Number;
         var _loc3_:* = _loc13_ = this.viewPortBounds.explicitHeight;
         if(_loc3_ !== _loc3_)
         {
            _loc3_ = 0;
         }
         this._ignoreChildChanges = true;
         var _loc19_:int = int(this.items.length);
         _loc7_ = 0;
         while(_loc7_ < _loc19_)
         {
            _loc15_ = this.items[_loc7_];
            ...
            _loc14_ = _loc15_.x;
            _loc10_ = _loc15_.y;
            _loc18_ = _loc14_ + _loc15_.width;
            _loc12_ = _loc10_ + _loc15_.height;
            if(_loc14_ === _loc14_ && _loc14_ < _loc5_)
            {
               _loc5_ = _loc14_;
            }
            if(_loc10_ === _loc10_ && _loc10_ < _loc6_)
            {
               _loc6_ = _loc10_;
            }
            ...
            if(_loc12_ === _loc12_ && _loc12_ > _loc3_)
            {
               _loc3_ = _loc12_;
            }
            _loc7_++;
         ...
         var _loc17_:Number = this.viewPortBounds.maxWidth;
         var _loc8_:Number = this.viewPortBounds.minHeight;
         var _loc16_:Number = this.viewPortBounds.maxHeight;
         var _loc11_:* = _loc4_ - _loc5_;
         if(_loc11_ < _loc1_)
         {
            _loc11_ = _loc1_;
         }
         else if(_loc11_ > _loc17_)
         {
            _loc11_ = _loc17_;
         }
         ...
         if(_loc9_ !== _loc9_)
         {
            this._actualVisibleWidth = _loc11_;
         }
         else
         {
         ...
         if(_loc13_ !== _loc13_)
         {
            this._actualVisibleHeight = _loc2_;
         }
         else
         {
            this._actualVisibleHeight = _loc13_;
         }
         this._layoutResult.contentX = 0;
         this._layoutResult.contentY = 0;
         this._layoutResult.contentWidth = _loc11_;
