   ...
   public class BaseDefaultItemRenderer extends ToggleButton
   {
      ...
      override protected function autoSizeIfNeeded() : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            {
               _loc4_ = this.addAccessoryWidth(_loc4_);
               _loc4_ = this.addIconWidth(_loc4_);
            }
            else
            {
               _loc4_ = this.addIconWidth(_loc4_);
            ...
            {
               if(this._originalSkinWidth > _loc4_)
               {
                  _loc4_ = this._originalSkinWidth;
               }
            }
         ...
         if(_loc5_)
         {
            ...
            if(this._layoutOrder == "labelAccessoryIcon")
            {
               _loc1_ = this.addAccessoryHeight(_loc1_);
               _loc1_ = this.addIconHeight(_loc1_);
            }
            else
            {
               _loc1_ = this.addIconHeight(_loc1_);
      ...
      protected function addAccessoryWidth(param1:Number) : Number
      {
         ...
         var _loc2_:Number = this.accessory.width;
         if(_loc2_ !== _loc2_)
         {
            return param1;
         }
      ...
      protected function addIconHeight(param1:Number) : Number
      {
         ...
         var _loc4_:Number = this.currentIcon.height;
         if(_loc4_ !== _loc4_)
         {
            return param1;
         }
      ...
      protected function commitData() : void
      {
         ...
         if(this._data && this._owner)
         {
            ...
            {
               _loc2_ = this.itemToIcon(this._data);
               this._iconIsFromItem = _loc2_ != null;
               this.replaceIcon(_loc2_);
            }
            ...
            {
               _loc3_ = this.itemToAccessory(this._data);
      ...
      override protected function layoutContent() : void
      {
         ...
         if(this._label && this.labelTextRenderer && _loc5_ && _loc4_)
         {
      ...
      override protected function refreshMaxLabelWidth(param1:Boolean) : void
      {
         ...
         var _loc7_:Number = this._gap;
         if(_loc7_ == Infinity)
         {
            _loc7_ = this._minGap;
         }
         var _loc8_:Number = this._accessoryGap;
         if(_loc8_ !== _loc8_)
         {
            _loc8_ = this._gap;
         }
         ...
         if(this.accessoryLabel)
         {
            _loc5_ = _loc6_ && (_loc4_ || this._layoutOrder == "labelAccessoryIcon");
            if(this.iconLabel)
            {
               this.iconLabel.maxWidth = _loc3_ - _loc7_;
            ...
            if(_loc5_)
            {
               _loc3_ -= this.currentIcon.width + _loc7_;
            }
            if(_loc4_)
            {
               _loc3_ -= _loc8_;
            ...
            if(_loc4_)
            {
               _loc3_ -= this.accessory.width;
            }
         }
         else if(this.iconLabel)
         {
            _loc2_ = _loc4_ && (_loc6_ || this._layoutOrder == "labelIconAccessory");
            if(this.accessory is IValidating)
            {
               IValidating(this.accessory).validate();
            }
            if(_loc2_)
            {
               _loc3_ -= _loc8_ + this.accessory.width;
            }
            if(_loc6_)
            {
               _loc3_ -= _loc7_;
         ...
         else
         {
            ...
            if(_loc6_)
            {
               _loc3_ -= _loc7_ + this.currentIcon.width;
            }
            if(this.accessory is IValidating)
            {
               IValidating(this.accessory).validate();
