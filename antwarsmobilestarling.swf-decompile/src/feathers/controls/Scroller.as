package feathers.controls
{
   ...
   public class Scroller extends FeathersControl
   {
      ...
      {
         var _loc6_:Boolean = this.isInvalid("size");
         var _loc7_:Boolean = this.isInvalid("data");
         var _loc3_:Boolean = this.isInvalid("scroll");
         var _loc9_:Boolean = this.isInvalid("clipping");
         var _loc12_:Boolean = this.isInvalid("styles");
         var _loc11_:Boolean = this.isInvalid("state");
         var _loc8_:Boolean = this.isInvalid("scrollBarRenderer");
         var _loc5_:Boolean = this.isInvalid("pendingScroll");
         var _loc10_:Boolean = this.isInvalid("pendingRevealScrollBars");
         if(_loc8_)
         {
         ...
         var _loc2_:Boolean = this.explicitWidth !== this.explicitWidth || this.explicitHeight !== this.explicitHeight;
         var _loc13_:Number = this._maxHorizontalScrollPosition;
         var _loc4_:Number = this._maxVerticalScrollPosition;
         var _loc1_:int = 0;
         do
         {
            this._hasViewPortBoundsChanged = false;
            if(_loc2_ && this._measureViewPort)
            {
               if(_loc3_ || _loc7_ || _loc6_ || _loc12_ || _loc8_)
               {
            ...
            _loc6_ = this.autoSizeIfNeeded() || _loc6_;
         ...
         if(_loc13_ != this._maxHorizontalScrollPosition)
         {
         ...
         if(_loc3_ || _loc6_ || _loc12_ || _loc11_ || _loc8_)
         {
            this.layoutChildren();
         }
         if(_loc3_ || _loc6_ || _loc12_ || _loc8_)
         {
            this.refreshScrollBarValues();
         }
         if(_loc3_ || _loc6_ || _loc12_ || _loc8_ || _loc9_)
         {
      ...
      protected function autoSizeIfNeeded() : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            {
               _loc3_ = this._viewPort.visibleWidth;
               if(_loc3_ !== _loc3_)
               {
                  _loc3_ = Number(this._viewPort.width);
               }
               _loc3_ += this._rightViewPortOffset + this._leftViewPortOffset;
            }
            else
            {
               _loc3_ = 0;
         ...
         if(_loc4_)
         {
            if(this._measureViewPort)
            {
               _loc1_ = this._viewPort.visibleHeight;
               if(_loc1_ !== _loc1_)
               {
                  _loc1_ = Number(this._viewPort.height);
               }
               _loc1_ += this._bottomViewPortOffset + this._topViewPortOffset;
            }
            else
            {
               _loc1_ = 0;
      ...
      protected function createScrollBars() : void
      {
         ...
         if(this._scrollBarDisplayMode != "none" && this._horizontalScrollPolicy != "off" && this._horizontalScrollBarFactory != null)
         {
            ...
            this.horizontalScrollBar.styleNameList.add(_loc2_);
         ...
         if(this._scrollBarDisplayMode != "none" && this._verticalScrollPolicy != "off" && this._verticalScrollBarFactory != null)
         {
            ...
            this.verticalScrollBar.styleNameList.add(_loc1_);
      ...
      protected function refreshViewPortBoundsWithoutFixedScrollBars() : void
      {
         ...
         var _loc5_:Number = this._topViewPortOffset + this._bottomViewPortOffset;
         this._viewPort.visibleWidth = this.explicitWidth - _loc2_;
         this._viewPort.visibleHeight = this.explicitHeight - _loc5_;
         var _loc3_:Number = this._minWidth - _loc2_;
         if(_loc3_ < 0)
         {
            _loc3_ = 0;
         }
         this._viewPort.minVisibleWidth = _loc3_;
         this._viewPort.maxVisibleWidth = this._maxWidth - _loc2_;
         var _loc4_:Number = this._minHeight - _loc5_;
         if(_loc4_ < 0)
         {
            _loc4_ = 0;
         }
         this._viewPort.minVisibleHeight = _loc4_;
         this._viewPort.maxVisibleHeight = this._maxHeight - _loc5_;
      ...
      protected function refreshViewPortBoundsWithFixedScrollBars() : void
      {
         ...
         var _loc5_:Number = this._topViewPortOffset + this._bottomViewPortOffset;
         var _loc2_:Boolean = this.explicitWidth != this.explicitWidth || this.explicitHeight !== this.explicitHeight;
         if(!(this._measureViewPort && _loc2_))
         {
            _loc3_ = this._minWidth - _loc1_;
            if(_loc3_ < 0)
            {
               _loc3_ = 0;
            }
            this._viewPort.minVisibleWidth = _loc3_;
            this._viewPort.maxVisibleWidth = this._maxWidth - _loc1_;
            _loc4_ = this._minHeight - _loc5_;
            if(_loc4_ < 0)
            {
               _loc4_ = 0;
            }
         ...
         this._viewPort.visibleWidth = this.actualWidth - _loc1_;
         this._viewPort.visibleHeight = this.actualHeight - _loc5_;
         this._viewPort.validate();
      }
      ...
      protected function refreshScrollValues() : void
      {
         ...
         if(_loc2_)
         {
            ...
            {
               this._targetHorizontalScrollPosition -= _loc1_ - this._maxHorizontalScrollPosition;
            ...
            {
               this._targetVerticalScrollPosition -= _loc3_ - this._maxVerticalScrollPosition;
      ...
      protected function refreshMinAndMaxScrollPositions() : void
      {
         ...
         if(this._viewPort)
         {
            ...
            this._maxHorizontalScrollPosition = this._minHorizontalScrollPosition + this._viewPort.width - _loc2_;
            ...
            this._maxVerticalScrollPosition = this._minVerticalScrollPosition + this._viewPort.height - _loc1_;
      ...
      protected function throwHorizontally(param1:Number) : void
      {
         ...
         if(this._snapToPages)
         {
            _loc6_ = 1000 * param1 / (DeviceCapabilities.dpi / Starling.contentScaleFactor);
            if(_loc6_ > this._minimumPageThrowVelocity)
            {
               _loc7_ = roundDownToNearest(this._horizontalScrollPosition,this.actualPageWidth);
            }
            else if(_loc6_ < -this._minimumPageThrowVelocity)
            {
               _loc7_ = roundUpToNearest(this._horizontalScrollPosition,this.actualPageWidth);
            }
            else
            {
               _loc5_ = this._maxHorizontalScrollPosition % this.actualPageWidth;
               _loc8_ = this._maxHorizontalScrollPosition - _loc5_;
               if(_loc5_ < this.actualPageWidth && this._horizontalScrollPosition >= _loc8_)
               {
                  _loc4_ = this._horizontalScrollPosition - _loc8_;
                  if(_loc6_ > this._minimumPageThrowVelocity)
                  {
                     _loc7_ = _loc8_ + roundDownToNearest(_loc4_,_loc5_);
                  }
                  else if(_loc6_ < -this._minimumPageThrowVelocity)
                  {
                     _loc7_ = _loc8_ + roundUpToNearest(_loc4_,_loc5_);
                  }
                  else
                  {
                     _loc7_ = _loc8_ + roundToNearest(_loc4_,_loc5_);
                  }
               }
               else
               {
                  _loc7_ = roundToNearest(this._horizontalScrollPosition,this.actualPageWidth);
               }
            }
            if(_loc7_ < this._minHorizontalScrollPosition)
            {
               _loc7_ = this._minHorizontalScrollPosition;
            }
            else if(_loc7_ > this._maxHorizontalScrollPosition)
            {
               _loc7_ = this._maxHorizontalScrollPosition;
            }
            if(_loc7_ == this._maxHorizontalScrollPosition)
            {
               _loc2_ = this._horizontalPageCount - 1;
            }
            else
            {
               _loc2_ = (_loc7_ - this._minHorizontalScrollPosition) / this.actualPageWidth;
            }
      ...
      protected function throwVertically(param1:Number) : void
      {
         ...
         if(this._snapToPages)
         {
            ...
            if(_loc6_ > this._minimumPageThrowVelocity)
            {
               _loc9_ = roundDownToNearest(this._verticalScrollPosition,this.actualPageHeight);
            }
            else if(_loc6_ < -this._minimumPageThrowVelocity)
            {
               _loc9_ = roundUpToNearest(this._verticalScrollPosition,this.actualPageHeight);
            }
            else
            {
               _loc2_ = this._maxVerticalScrollPosition % this.actualPageHeight;
               _loc7_ = this._maxVerticalScrollPosition - _loc2_;
               if(_loc2_ < this.actualPageHeight && this._verticalScrollPosition >= _loc7_)
               {
                  _loc4_ = this._verticalScrollPosition - _loc7_;
                  if(_loc6_ > this._minimumPageThrowVelocity)
                  {
                     _loc9_ = _loc7_ + roundDownToNearest(_loc4_,_loc2_);
                  }
                  else if(_loc6_ < -this._minimumPageThrowVelocity)
                  {
                     _loc9_ = _loc7_ + roundUpToNearest(_loc4_,_loc2_);
                  }
                  else
                  {
                     _loc9_ = _loc7_ + roundToNearest(_loc4_,_loc2_);
                  }
               }
               else
               {
                  _loc9_ = roundToNearest(this._verticalScrollPosition,this.actualPageHeight);
               }
            }
            ...
            if(_loc9_ == this._maxVerticalScrollPosition)
            {
               _loc5_ = this._verticalPageCount - 1;
            }
            else
            {
               _loc5_ = (_loc9_ - this._minVerticalScrollPosition) / this.actualPageHeight;
            }
            this.throwToPage(-1,_loc5_,this._pageThrowDuration);
            return;
         }
         var _loc8_:Number = Math.abs(param1);
         if(_loc8_ <= 0.02)
         {
            this.finishScrollingVertically();
            return;
      ...
      {
         var _loc1_:Number = Math.abs(this._targetHorizontalScrollPosition - this._startHorizontalScrollPosition);
         var _loc2_:Number = 0;
         if(this._targetHorizontalScrollPosition > this._maxHorizontalScrollPosition)
         {
            _loc2_ = (this._targetHorizontalScrollPosition - this._maxHorizontalScrollPosition) / _loc1_;
         }
         else if(this._targetHorizontalScrollPosition < this._minHorizontalScrollPosition)
         {
            _loc2_ = (this._minHorizontalScrollPosition - this._targetHorizontalScrollPosition) / _loc1_;
         }
         if(_loc2_ > 0)
         {
            if(this._hasElasticEdges)
      ...
      {
         var _loc1_:Number = Math.abs(this._targetVerticalScrollPosition - this._startVerticalScrollPosition);
         var _loc2_:Number = 0;
         if(this._targetVerticalScrollPosition > this._maxVerticalScrollPosition)
         {
            _loc2_ = (this._targetVerticalScrollPosition - this._maxVerticalScrollPosition) / _loc1_;
         }
         else if(this._targetVerticalScrollPosition < this._minVerticalScrollPosition)
         {
            _loc2_ = (this._minVerticalScrollPosition - this._targetVerticalScrollPosition) / _loc1_;
         }
         if(_loc2_ > 0)
         {
            if(this._hasElasticEdges)
