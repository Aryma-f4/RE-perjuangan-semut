...
public interface ILocationSourceDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements ILocationSourceDelegate {
        ...
        private static class C0032a implements ILocationSourceDelegate {
            private IBinder a;
        ...
        public static ILocationSourceDelegate y(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ILocationSourceDelegate)) ? new C0032a(iBinder) : (ILocationSourceDelegate) iInterfaceQueryLocalInterface;
        }
