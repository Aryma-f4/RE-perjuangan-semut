...
public interface i extends IInterface {
    ...
    public static abstract class a extends Binder implements i {
        ...
        private static class C0044a implements i {
            private IBinder a;
        ...
        public static i F(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof i)) ? new C0044a(iBinder) : (i) iInterfaceQueryLocalInterface;
        }
