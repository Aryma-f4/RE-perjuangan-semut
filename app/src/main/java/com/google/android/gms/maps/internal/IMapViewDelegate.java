...
public interface IMapViewDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IMapViewDelegate {
        ...
        private static class C0034a implements IMapViewDelegate {
            private IBinder a;
        ...
        public static IMapViewDelegate A(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IMapViewDelegate)) ? new C0034a(iBinder) : (IMapViewDelegate) iInterfaceQueryLocalInterface;
        }
