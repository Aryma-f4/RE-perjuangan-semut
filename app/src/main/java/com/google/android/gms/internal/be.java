...
public interface be extends IInterface {
    ...
    public static abstract class a extends Binder implements be {
        ...
        private static class C0010a implements be {
            private IBinder a;
        ...
        public static be q(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof be)) ? new C0010a(iBinder) : (be) iInterfaceQueryLocalInterface;
        }
