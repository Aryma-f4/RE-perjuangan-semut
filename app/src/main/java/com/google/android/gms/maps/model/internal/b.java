...
public interface b extends IInterface {
    ...
    public static abstract class a extends Binder implements b {
        ...
        public static b O(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof b)) ? new C0053a(iBinder) : (b) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case R.styleable.ActionBar_progressBarPadding /* 17 */:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.ICircleDelegate");
                    boolean zA = a(O(data.readStrongBinder()));
                    reply.writeNoException();
