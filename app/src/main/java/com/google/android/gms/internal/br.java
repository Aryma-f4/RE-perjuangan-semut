...
public interface br extends IInterface {
    ...
    public static abstract class a extends Binder implements br {
        ...
        private static class C0016a implements br {
            private IBinder a;
        ...
        public static br aa(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof br)) ? new C0016a(iBinder) : (br) iInterfaceQueryLocalInterface;
        }
