...
public interface f extends IInterface {
    ...
    public static abstract class a extends Binder implements f {
        ...
        public static f T(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof f)) ? new C0057a(iBinder) : (f) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 8:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    boolean zA = a(T(data.readStrongBinder()));
                    reply.writeNoException();
