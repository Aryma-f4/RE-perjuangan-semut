...
public interface l extends IInterface {
    ...
    public static abstract class a extends Binder implements l {
        ...
        private static class C0047a implements l {
            private IBinder a;
        ...
        public static l I(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof l)) ? new C0047a(iBinder) : (l) iInterfaceQueryLocalInterface;
        }
