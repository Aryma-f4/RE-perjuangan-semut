...
public interface bm extends IInterface {
    ...
    public static abstract class a extends Binder implements bm {
        ...
        private static class C0013a implements bm {
            private IBinder a;
        ...
        public static bm W(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof bm)) ? new C0013a(iBinder) : (bm) iInterfaceQueryLocalInterface;
        }
