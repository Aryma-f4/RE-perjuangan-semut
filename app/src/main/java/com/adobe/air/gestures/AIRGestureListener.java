...
public class AIRGestureListener implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener, ScaleGestureDetector.OnScaleGestureListener {
    ...
    public boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f, float f2) {
        ...
        if (motionEvent2.getPointerCount() == 2) {
            ...
            if (i3 >= 0 && i3 < 2 && i4 >= 0 && i4 < 2) {
                if (!this.mInPanTransformGesture) {
                    ...
                    if (this.mInRotateTransformGesture || Math.abs(f3) > _FP_GESTURE_ROTATION_THRESHOLD_DEGREES) {
                        ...
                        nativeOnGestureListener(i5, 2, true, x, y, 1.0f, 1.0f, f4, 0.0f, 0.0f);
                        f5 = 0.0f;
                        i = i5;
                    }
                }
                if (!this.mInZoomTransformGesture && !this.mInRotateTransformGesture) {
                    if (isPanGesture(this.mDownTouchPoints[i3], this.mDownTouchPoints[i4], touchPointArr[0], touchPointArr[1])) {
                        ...
                        nativeOnGestureListener(i, 1, true, x, y, 1.0f, 1.0f, f5, (-1.0f) * f, (-1.0f) * f2);
            ...
            if (z) {
                nativeOnGestureListener(8, 5, true, motionEvent.getX(0), motionEvent2.getY(0), 1.0f, 1.0f, 0.0f, f6, f7);
    ...
    public boolean onTwoFingerTap() {
        ...
        boolean z = 1 != 0 && nativeOnGestureListener(8, 3, false, (this.mSecondaryPointOfTwoFingerTap.x + this.mPrimaryPointOfTwoFingerTap.x) / 2.0f, (this.mSecondaryPointOfTwoFingerTap.y + this.mPrimaryPointOfTwoFingerTap.y) / 2.0f, 1.0f, 1.0f, 0.0f, 0.0f, 0.0f);
    ...
    public boolean onDoubleTap(MotionEvent motionEvent) {
        if (motionEvent.getPointerCount() == 1) {
            return 1 != 0 && this.mSurfaceView.nativeOnDoubleClickListener(motionEvent.getX(0), motionEvent.getY(0));
        }
        return true;
    }
    ...
    public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
        ...
        if (previousSpan != 0.0d) {
            if (this.mInZoomTransformGesture || (25.399999618530273d * dAbs3) / screenPPI > 8.0d) {
                ...
                nativeOnGestureListener(i2, 0, true, focusX, focusY, f2, f, 0.0f, 0.0f, 0.0f);
                return true;
            }
            return false;
        }
